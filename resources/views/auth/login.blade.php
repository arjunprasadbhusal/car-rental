...
<body>
    <div class="grid grid-cols-2">
        <img src="https://www.bitmapitsolution.com/images/login/login.jpg" alt="" class="h-screen w-full border-r">
        <div class="flex items-center justify-center">
            <div class="text-center w-6/12">
                <img src="https://www.bitmapitsolution.com/images/logo/logo.png" alt="" class="h-24 mx-auto">
